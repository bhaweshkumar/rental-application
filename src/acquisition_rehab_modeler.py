...
def show_acquisition_rehab_modeler():
    ...
    with st.form("acquisition_form"):
        ...
        # Get existing acquisition details from the session state's data model
        ...
        # Calculate all rehab costs once based on current UI state and display them.
        ...
        if submitted:
            # On submit, the values are already calculated from the form inputs. We just save them.
