"""
Authoritative domain models for the rental underwriting platform.

All application code should import from this module (or from rental_platform.models).
Do NOT import from src.logic.models, src.shared.models, or the root models.py.
"""
import uuid
...
class DealProfile:
    ...
    status: str = "Analysis"  # "Analysis", "Under Contract", "Closed", "Rejected"
